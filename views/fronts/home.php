            ...
            <div class="col-md-9 col-lg-9 col-sm-8 col-xs-12 float-left-style">
                ...
                <div class="slider__container slider--one">
                    <div class="slider__activation__wrap owl-carousel owl-theme">
                        <!-- Start Single Slide -->
                        <div class="slide slider__full--screen slider-height-inherit slider-text-right" style="background: rgba(0, 0, 0, 0) url(images/picture/d.jpg) no-repeat scroll center center / cover ;">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-10 col-lg-8 col-md-offset-2 col-lg-offset-4 col-sm-12 col-xs-12">
                                        <div class="slider__inner">
                                            ...
                                            <div class="slider__btn">
                                                <a class="htc__btn" href="index.php?f=cart">shop now</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <!-- End Single Slide -->
                        <!-- Start Single Slide -->
                        <div class="slide slider__full--screen slider-height-inherit  slider-text-left" style="background: rgba(0, 0, 0, 0) url(images/picture/d1.jpg) no-repeat scroll center center / cover ;">
                            <div class="container">
                                <div class="row">
            ...
            <div class="col-md-3 col-lg-3 col-sm-4 col-xs-12 float-right-style">
                <div class="categories-menu mrg-xs">
                   ...
                   <div class="category-menu-list">
                    <ul>
                        <?php
                        $result = $db->view("*","categories");
                        while ($v = $result->fetch_object()) {  
                         ?>
                         <li><a href="#"><img alt="" src="images/icons/thum2.png"> <?php echo $v->name;; ?> <i class="zmdi zmdi-chevron-right"></i></a>
...
<div class="only-banner ptb--100 bg__white">
    <div class="container">
        <div class="only-banner-img">
            <a href="shop-sidebar.php"><img src="images/picture/a.jpg" alt="new product"></a>
        </div>
    </div>
</div>
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="product-style-tab">
                    ...
                    <div class="tab-content another-product-style jump">
                       <div class="tab-pane active" id="home1"> 
                        <?php 
                        $result=$db->rawQuery(" select * from products where subcategory_id=4 order by id desc limit 4");
                        while ($v =$result->fetch_object()) {
                            ?>
                                        ...
                                        <div class="product">
                                          ...
                                          <div class="product__inner">
                                            <div class="pro__thumb">
                                                <a href="#">
                                                    <img src="images/picture/<?php echo $v->id ?>.<?php echo $v->default_picture  ?>" alt="product images">
                                                </a>
                                            </div>
                                            <div class="product__hover__info">
                                                <ul class="product__action">
                                                    <li><a data-toggle="modal" data-target="#productModal" title="Quick View" class="quick-view modal-view detail-link" href="index.php?f=product-details&pdtid=<?php echo $v->id ?>"><span class="ti-plus"></span></a></li>
                                                    <li><a title="Add TO Cart" href="index.php?f=cart"><span class="ti-shopping-cart"></span></a></li>
                                                    <li><a title="Wishlist" href="index.php?f=wishlist"><span class="ti-heart"></span></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="product__details">
                                            <h2><a href="index.php?f=product-details&pdtid=<?php echo $v->id ?>"><?php echo $v->title ?></a></h2>
                                            <ul class="product__price">
                                                <li class="new__price">$<?php echo $v->price ?></li>
                                            </ul>
                                        </div>
                ...
                <div class="tab-pane" id="home2">
                    <?php 
                    $result=$db->rawQuery(" select * from products where subcategory_id=1 order by id desc limit 4");
                    while ($v =$result->fetch_object()) {
                        ?>
                        <div class="row">
                            <div class="product-slider-active owl-carousel">
                ...
                <div class="tab-pane" id="home3">
                 <?php 
                 $result=$db->rawQuery(" select * from products where subcategory_id=15 order by id desc limit 4");
                 while ($v =$result->fetch_object()) {
                    ?>
            ...
            <div class="tab-pane" id="home4">
             <?php 
             $result=$db->rawQuery(" select * from products where subcategory_id=16  order by id desc limit 4");
             while ($v =$result->fetch_object()) {
                ?>
                <div class="row">
                    <div class="product-slider-active owl-carousel">
...
<div class="only-banner bg__white">
    <div class="container">
        <div class="only-banner-img">
            <a href="shop-sidebar.php"><img src="images/new-product/7.jpg" alt="new product"></a>
        </div>
    </div>
</div>
<!-- Start Our Product Area -->
